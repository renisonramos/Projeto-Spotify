...
const Song = () => {
  ...
  const { image, name, duration, artist, audio } = songsArray.filter(
    ...
    (currentSongObj) => currentSongObj._id === id // Converte o ID para número para garantir a comparação correta.
  ...
  const randomIdFromArtist = songsArrayFromArtist[randomIdex]._id; // Obtém o ID da primeira música aleatória do artista.
  const randomId2FromArtist = songsArrayFromArtist[randomIdex2]._id; // Obtém o ID da segunda música aleatória do artista.
