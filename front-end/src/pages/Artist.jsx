...
const Artist = () => {
  ...
  const { name, banner } = artistArray.filter(
    ...
    (currentArtistObj) => currentArtistObj._id === id // Converte o ID para número para garantir a comparação correta.
  ...
  const randomIdFromArtist = songsArrayFromArtist[randomIndex]._id; // Obtém o ID da música aleatória do artista.
